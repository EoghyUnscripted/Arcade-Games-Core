from Apps.Quiz_Game.Data import quiz_game_data as data
from Apps.Quiz_Game.Classes import Question, Brain

def load():
    """Function to run the Quiz Game app."""
    ...
    quiz = Brain.Brain(question_bank)  # Create new quiz object
